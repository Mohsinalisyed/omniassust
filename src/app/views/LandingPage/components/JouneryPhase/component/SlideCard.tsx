...
const SlideCard:React.FC<IPhaseData>= ({heading, description, img}) => {
  return (
    <div className="w-[277px] p-2 min-h-[164px] border border-white/30 bg-card_background  border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 cursor-pointer">
