...
const SlideCard:React.FC<IPhaseData>= ({heading, description, img}) => {
  return (
    <div className="max-w-sm mr-8 p-4 border border-white/30 bg-card_background  border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 cursor-pointer">
